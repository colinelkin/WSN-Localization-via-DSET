function erg=dsadf(fhandle,intervalnumber,varargin)
%=========================================================================   
% dsadf
%=========================================================================   
% y=dsadf(fhandle,intervalnumber,varargin) 
% Discretizes a given inverse probability cdf using the averaged discretization method. 
%
% Input: 
...
%=========================================================================
mythres=0.9999999/fix(intervalnumber);
erg=dsstruct;
count=1;
params=[varargin{:}];
l=length(params);
...
%    for j=mythres:mythres:0.999999
        temp(1:l)=2;
        doe2=fullfact(temp);
        for k=1:size(doe2,1)
            for k2=1:l
            ...
            t=mythres:mythres:0.999999;
            borders(:,k)=feval(fhandle,t'-mythres/2,peval{:});
        end

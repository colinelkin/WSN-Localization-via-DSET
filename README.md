Simulates localization of sensor nodes in a wireless sensor network using Dempster-Shafer Evidence Theory (DSET). The program runs by launching run_simulation.m in MATLAB.
